  ...
  return (
    <div className={s.container}>
      ...
      <p className={s.parag}>
        ...
        developer. As a team lead on the project, I needed to set up a GitHub
        repository for project contributors, as well as hook up styles with
        basic settings and fonts. As a team leader, I checked, accepted pull
        requests, and helped project participants. As a developer I was
        responsible for the "work-together" section.
      </p>
